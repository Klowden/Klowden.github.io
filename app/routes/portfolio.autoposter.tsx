export default function AutoPoster() {
	return (
		<div className='flex flex-col items-center max-w-[80rem] mx-0 sm:mx-6 lg:mx-8 my-4 sm:my-8 py-4 bg-gradient-to-b from-gray-900 to-gray-800 rounded-lg shadow-lg border border-gray-700'>
			{/* Header Section */}
			<section className='text-center'>
				...
				<p className='text-lg text-gray-400 leading-relaxed max-w-3xl mx-auto bg-gray-900 py-4 px-8 rounded-2xl shadow-md'>
			...
			{/* Details Section */}
			<section className='mt-12 grid gap-12 lg:grid-cols-2 px-0 sm:px-6 lg:px-8'>
				{/* Text Content */}
