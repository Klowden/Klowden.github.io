...
export default function Cooledtured() {
	...
	return (
		<div className='relative flex flex-col items-center max-w-[80rem] mx-0 sm:mx-6 lg:mx-8 my-4 sm:my-8 py-6 bg-gradient-to-b from-gray-900 to-gray-800 rounded-lg shadow-lg border border-gray-700'>
			{/* Decorative Accents */}
			<div className='absolute inset-x-0 top-0 h-4 bg-gradient-to-r from-purple-600 via-amber-500 to-pink-600'></div>
			<div className='absolute inset-x-0 bottom-0 h-4 bg-gradient-to-r from-green-500 via-amber-500 to-purple-600'></div>
			...
			<section className='w-full mt-8 px-4 sm:px-6 lg:px-8'>
				<h2 className='text-center text-4xl sm:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-amber-500 to-pink-600 mb-12 relative'>
					Carousel Showcase
					<span className='absolute bottom-[-0.5rem] left-1/2 transform -translate-x-1/2 h-1 w-48 bg-gradient-to-r from-purple-600 to-amber-500 rounded-full'></span>
				</h2>
			...
			<section className='w-full mt-8 px-4 sm:px-6 lg:px-8'>
				<h2 className='text-center text-3xl font-bold text-amber-500 mb-6 relative'>
					Thumbnail Gallery
					<span className='absolute bottom-[-0.25rem] left-1/2 transform -translate-x-1/2 h-1 w-32 bg-gradient-to-r from-amber-500 to-purple-600 rounded-full'></span>
				</h2>
